...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.core = new core_1.default(this.spec, 'picsartfordevelopers/2.0 (api/6.1.3)');
    }
    /**
     ...
     */
    SDK.prototype.imageRemoveBackground = function (body) {
     ...
     */
    SDK.prototype.imageUpscale = function (body) {
     ...
     */
    SDK.prototype.imageUltraUpscale = function (body) {
     ...
     */
    SDK.prototype.imageUltraUpscaleGetresult = function (metadata) {
     ...
     */
    SDK.prototype.imageUltraEnhance = function (body) {
     ...
     */
    SDK.prototype.imageFaceEnhance = function (body) {
     ...
     */
    SDK.prototype.imageListEffectNames = function () {
     ...
     */
    SDK.prototype.imageApplyEffect = function (body) {
     ...
     */
    SDK.prototype.imageCreateEffectPreviews = function (body) {
     ...
     */
    SDK.prototype.imageApplyLaserEngravingEffect = function (body) {
        return this.core.fetch('/effects/laserengraving', 'post', body);
    };
    /**
     * **Service Description:**
     ...
     */
    SDK.prototype.imageListAiEffectNames = function () {
     ...
     */
    SDK.prototype.imageApplyAiEffect = function (body) {
     ...
     */
    SDK.prototype.imageAdjust = function (body) {
     ...
     */
    SDK.prototype.imageTransferColor = function (body) {
     ...
     */
    SDK.prototype.imageTransferStyle = function (body) {
     ...
     */
    SDK.prototype.imageCreateMaskPreviews = function (body) {
     ...
     */
    SDK.prototype.imageApplyMask = function (body) {
     ...
     */
    SDK.prototype.imageGenerateTexture = function (body) {
     ...
     */
    SDK.prototype.imageGeneratePattern = function (body) {
        return this.core.fetch('/background/pattern', 'post', body);
    };
    /**
     * **Service Description:**
     ...
     */
    SDK.prototype.imageVectorizeRasterToSvg = function (body) {
     ...
     */
    SDK.prototype.imageDesignImport = function (body) {
     ...
     */
    SDK.prototype.imageDesignImportGetresult = function (metadata) {
     ...
     */
    SDK.prototype.imageSurfacemap = function (body) {
     ...
     */
    SDK.prototype.imageUpload = function (body) {
     ...
     */
    SDK.prototype.imageCreditsBalance = function () {
     ...
     */
    SDK.prototype.imageEdit = function (body) {
     ...
     */
    SDK.prototype.imageBlend = function (body) {
        return this.core.fetch('/blend', 'post', body);
    };
    /**
     * **Service Description:**
     ...
     */
    SDK.prototype.imageTagging = function (body) {
     ...
     */
    SDK.prototype.imageDescriber = function (body) {
     ...
     */
    SDK.prototype.imageCarsClassifier = function (body) {
        return this.core.fetch('/cars/classify', 'post', body);
    };
    return SDK;
}());
